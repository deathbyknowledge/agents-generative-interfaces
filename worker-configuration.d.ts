// Generated by Wrangler by running `wrangler types` (hash: 49ab9ab0144679718eea902350d34a2b)
// Runtime types generated with workerd@1.20250317.0 2025-08-26 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		AGENT: DurableObjectNamespace<import("./src/index").GenUIAgent>;
		BUCKET: R2Bucket;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "DEEPSEEK_API_KEY" | "GROQ_API_KEY" | "CEREBRAS_API_KEY" | "OPENROUTER_API_KEY">> {}
}
